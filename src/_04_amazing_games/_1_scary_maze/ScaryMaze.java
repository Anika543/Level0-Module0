...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("pixil-frame-0 (9).png"));
	...
	private void scare() {
		...
		if (canPlaySounds) {
		    ...
		    playScarySound("192672__tamerursavas__scary-hit.wav");
		}	
		/**********  SHOW A PICTURE ***************/
		...
		showScaryImage("write-ghost-story.png");
